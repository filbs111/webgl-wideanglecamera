...
var getRotationFromDirectionPairs = (function(){
	...
	var constpll=1;
	//var constperp = 1000000;
	var constperp = 5;	//as far as i can calculate, this number should be big, but in fact if big, get erroneous z rotation when drag single digit past centre of screen. 
						//making this smaller seems to fix that, for unknown reasons.
	...
	return function(pairs){
		...
		for (var ii=0;ii<pairs.length;ii++){
			...
			var L = crossProduct( normalise( subtractVector(startdirection, enddirection) ) , normalise(M) );
		...
		mymat3[0]= 2*cxx;	mymat3[1]= cxy;		mymat3[2]= cxz;
		mymat3[3]= cxy;		mymat3[4]= 2*cyy;	mymat3[5]= cyz;
		mymat3[6]= cxz;		mymat3[7]= cyz;		mymat3[8]= 2*czz;
